...
export function SyncPanel({ onSynced }: { onSynced: () => void }) {
  ...
  const signOut = async () => { await CloudSync.signOut(); setUserEmail(null); setStatus('signed-out'); setIsOpen(true); };
